function sendMoney(){
	...
	alert(`Successful Transaction !!  
	       $${enterAmount} is sent to ${enterName}@tfs.com.`)
	
	// transaction history 
	var createPTag=document.createElement("li");
	var textNode=document.createTextNode(`Rs${enterAmount} is sent from the sender with Bank-id ${enterSName}@tfs.com
	  to recepient with Bank-id-id ${enterName}@tfs.com on ${Date()}.`);
